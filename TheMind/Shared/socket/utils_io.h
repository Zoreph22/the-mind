 ...
 * Cette fonction assure la lecture de la totalité des données jusqu'au @p n ième octets.
 ...
 * Cette fonction assure l'écriture de la totalité des données jusqu'au @p n ième octets.
 * @param fd Descripteur de fichier où écrire les données.
 * @param ptrBuffer Pointeur du buffer où lire les données à écrire.
